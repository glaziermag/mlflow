...
def _subprocess_env() -> dict[str, str]:
    return os.environ | {
        ...
        # The endpoint under benchmark points at the local fake OpenAI server over plain
        # HTTP on loopback, which the gateway secret `api_base` SSRF guard rejects by default.
